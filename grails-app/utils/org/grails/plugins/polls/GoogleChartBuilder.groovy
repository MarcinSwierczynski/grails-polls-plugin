/*
 * Ta klasa pochodzi z Google Chart Plugin
 * http://grails.org/plugin/google-chart
 * Ponieważ autorzy pluginu nie umieścili jej w żadnym pakiecie, był problem
 * z dostępem do niej.
 *
 * dokumentacja
 * http://zanthrash.com/GoogleChartBuilder.html
